...
interface FeedbackTypeStepProps {
  handleSelectFeedback: (type: FeedbackType) => void;
}

export function FeedbackTypeStep({ handleSelectFeedback }: FeedbackTypeStepProps) {
  return (
    <>
      <header>
      ...
      <div className="flex py-8 gap-2 w-full">
        { Object.entries(feedbackTypes).map(([key, value]) => (
          <button
            ...
            onClick={() => handleSelectFeedback(key as FeedbackType)}
          >
